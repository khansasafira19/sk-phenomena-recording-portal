...
$this->title = 'Jumlah Fenomena yang Terjadi';
        ...
        <?php if ($dataProvider->totalCount > 0) : ?>
            <div class="col-md-6">
                ...
                <div class="text-center">
                    <?= Html::a('<i class="fas fa-globe"></i> Cek Seluruh Jumlah Fenomena dari Tahun 2015', ['/fenomena/jumlahfen?a=&b='], ['class' => 'btn btn-info ', 'style' => 'text-decoration:none!important']) ?>
                </div>
            </div>
            <div class="col-md-6">
                <?php
                ...
                echo Highcharts::widget([
                    'options' => [
                        ...
                        'title' => [
                            'text' => 'Jumlah Fenomena yang Terjadi'
                        ],
        ...
        <?php else : ?>
            <div class="card card-default">
                ...
                <div class="card-footer">
                    <?= Html::a('<i class="fas fa-globe"></i> Cek Seluruh Jumlah Fenomena dari Tahun 2015', ['/fenomena/jumlahfen?a=&b='], ['class' => 'btn btn-info  bg-biru-muda', 'style' => 'text-decoration:none!important']) ?>
                </div>
            </div>
        <?php endif; ?>
    </div>
