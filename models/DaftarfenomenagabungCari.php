...
use app\models\Daftarfenomenagabung;

/**
 * DaftarfenomenagabungCari represents the model behind the search form of `app\models\Daftarfenomenagabung`.
 */
class DaftarfenomenagabungCari extends Daftarfenomenagabung
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['tahun', 'judul', 'fenomena', 'sumberket', 'tgl_rekam', 'perekam', 'kategori', 'idkat', 'satker', 'month', 'triwulan'], 'safe'],
        ];
    }
    ...
    {
        $query = Daftarfenomenagabung::find()
                ->where(['deleted' => 0])
        ...
        $dataProvider = new ActiveDataProvider([
            ...
            //'sort' => ['defaultOrder' => ['kategori' => SORT_ASC, 'tahun' => SORT_DESC, 'bulan' => SORT_DESC, 'tgl_rekam' => SORT_DESC]]
        ]);
        ...
        $query->andFilterWhere(['like', 'judul', $this->judul])
            ->andFilterWhere(['like', 'fenomena', $this->fenomena])
            ...
            ->andFilterWhere(['like', 'idkat', $this->idkat]);
