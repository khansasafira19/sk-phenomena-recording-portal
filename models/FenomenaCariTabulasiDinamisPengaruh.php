...
class FenomenaCariTabulasiDinamisPengaruh extends Fenomena {
    ...
    public function rules() {
        return [
            ...
            [['tahun', 'fenomena', 'sumberket', 'tgl_rekam', 'perekam', 'satker', 'month', 'namabulan', 'triwulan', 'pengaruh'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        $query = Fenomena::find()
                ...
                ->select(['id', 'bulan as bulan', 'bulan.nama_bulan as namabulan', 'satker.nama_satker as wilayah', 'wilayah as wil', 'count(tgl_rekam) as fen', 'tahun as tahun',
                    'SUM(if(pengaruh = 1, 1, 0)) AS fenpos',
                    'SUM(if(pengaruh = 0, 1, 0)) AS fenneg',
                    'SUM(kat01 = 1) AS L1',
                    'SUM(kat02 = 1) AS L2',
                    'SUM(kat03 = 1) AS L3',
                    'SUM(kat04 = 1) AS L4',
        ...
        $query->andFilterWhere(['pengaruh' => $this->pengaruh]);
